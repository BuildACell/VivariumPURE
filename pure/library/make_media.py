...
# Raw data class
from pure.library.knowledge_base import KnowledgeBase
...
class Media(object):
    ...
    def _get_environment_molecules_fw(self, raw_data):
        ...
        for row in raw_data.ecoli_environment_molecules:
            mol = row["molecule id"]
        ...
        for ingredient, amount in recipe.items():
            ...
            # if it is not an existing media, it needs weight or counts to add
                ...
                if added_weight.magnitude == INF:
                    ...
                    raise AddIngredientsError(
                        "No fw defined for {} in ecoli_environment_molecules.tsv".format(ingredient))
...
# python pure/library/make_media.py
